...
public class Employee 
{
	public static void main(String[] args) 
	{
		...
		empList = Arrays.asList(
				new EmployeeRepository(100, 1, "Abhinav", "Shukla", "shukla7@gmail.com", "9158106688", "Executive",
						LocalDate.of(2021, 4, 17), 25000d, dept),
				new EmployeeRepository(201, 2, "Ram", "Kumar", "ramkumar1@gmail.com", "9096684836", "Analyst",
						LocalDate.of(2021, 4, 11), 30000d, dept1),
				new EmployeeRepository(103, 1, "Shyam", "Sharma", "shyamsharma@gmail.com", "8983349675", "Analyst",
						LocalDate.of(2021, 4, 05), 20500d, dept),
				new EmployeeRepository(102, 1, "Manish", "Paul", "manishpaul@gmail.com", "9823079331", "Analyst",
						LocalDate.of(2021, 4, 17), 20000d, dept),
				new EmployeeRepository(101, 1, "Rita", "Dey", "rita@gmail.com", "9657887314", "Analyst",
						LocalDate.of(2021, 4, 20), 23000d, dept),
				new EmployeeRepository(202, 2, "Aditya", "Synde", "aditya@gmail.com", "9865674311", "Executive",
